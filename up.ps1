...
& docker\build\cm\templates\import-templates.ps1 -RenderingSiteName "sitecoreslayers" -SitecoreApiKey $sitecoreApiKey

if ($ClientCredentialsLogin -ne "true") {
    Write-Host "Opening site..." -ForegroundColor Green
    
    Start-Process https://sitecoreslayerscm.localhost/sitecore/
}
